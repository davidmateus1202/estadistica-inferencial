...
public class laliga extends JFrame {
	...
	public laliga() {
		...
		panel_5.setBounds(625, 51, 76, 107);
		panel_desliza.add(panel_5);
		
		JPanel panel_2 = new JPanel();
		panel_2.setBorder(null);
		panel_2.setBackground(Color.BLACK);
		panel_2.setBounds(303, 51, 56, 90);
		...
		marcajugador.setBounds(278, 51, 76, 90);
		panel_desliza.add(marcajugador);
		
		
		marcarival.setFont(new Font("Agency FB", Font.BOLD, 50));
		marcarival.setForeground(Color.WHITE);
		marcarival.setBounds(600, 51, 76, 90);
		panel_desliza.add(marcarival);
		
		JLabel lblNewLabel_2_3 = new JLabel("-");
		lblNewLabel_2_3.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2_3.setFont(new Font("Agency FB", Font.BOLD, 99));
		lblNewLabel_2_3.setForeground(Color.WHITE);
		lblNewLabel_2_3.setBounds(437, 51, 76, 90);
		panel_desliza.add(lblNewLabel_2_3);
