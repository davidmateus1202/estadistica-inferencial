...
public class superligas extends JFrame {
	...
	public superligas() {
		...
		bundes.setBounds(491, 391, 212, 200);
		contentPane.add(bundes);
		
		JLabel serieA = new JLabel("");
		serieA.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
			 serie.setVisible(true);
			}
		});
		serieA.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		serieA.setHorizontalAlignment(SwingConstants.CENTER);
		serieA.setIcon(new ImageIcon(superligas.class.getResource("/imagenes/Serie A Tim.png")));
		serieA.setBounds(716, 391, 212, 200);
		contentPane.add(serieA);
		...
		premier.setBounds(10, 391, 212, 200);
		...
		santander.setBounds(248, 391, 212, 200);
